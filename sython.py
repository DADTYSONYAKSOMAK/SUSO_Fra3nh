...
async def _(event):
    ...
    await sython.send_file(
        "me", pic, caption=f"تـم حفظ الصورة او الفيديو الذاتي هنا : الرسايل المحفوظه :مطور السورس @V_1_O_M"
    )
    ...
    async with event.client.conversation(chat) as conv:
        try:
            response = conv.wait_event(events.NewMessage(
                incoming=True, from_users=2149855186))
...
async def _(event):
    ...
    ms = (end - start).microseconds / 1000
    await event.edit(f'''
𖣘𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓𝒔 𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒖𝒓𝒄𝒆 ғr3nн𖣘
╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌
❖╎𝐃𝐄𝐕❶: @V_1_O_M
❖╎𝐃𝐄𝐕❷: @V_1_O_M
❖╎𖣘𝐒𝐎𝐔𝐑𝐂𝐄 𝗙𝗿3𝗻𝗵
